...
public class StudentAttendanceStatusApi extends AsyncTask<String, Void, String>
{

    private static final String LOGIN_URL = "API To Show Attendance";
    private static final String TOKEN = "TOKEN";
    private static final String COURSENAME = "COURSENAME";
    Context context;
    public StudentAttendanceStatusApi(Context c) {
        context=c;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            requestParams.append(COURSENAME).append("=").append(courseName);
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                Log.e("StudentAttendanceApi", "POST request failed. Response code: " + responseCode);
                return null;
            }
        } catch (Exception e) {
            Log.e("StudentAttendanceApi", "Error: " + e.getMessage());
            return null;
        }
    }
